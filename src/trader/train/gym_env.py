...
class GymEventRungEnv(gym.Env):
    """Gymnasium wrapper for the event-driven `EventRungEnv` (rung 1). One scalar action in [0,1]
    interpreted by event type (entry sizing / exit keep-fraction); obs is the core env's vector."""
